...
| Differential privacy lane/runtime path | Explicitly removed from this release; tracked by reintroduction plan | Not Implemented | [`docs/IMPLEMENTATION_STATUS.md`](IMPLEMENTATION_STATUS.md), [`docs/DP_REINTRODUCTION_PLAN.md`](DP_REINTRODUCTION_PLAN.md) |
